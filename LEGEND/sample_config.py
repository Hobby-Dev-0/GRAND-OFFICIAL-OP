...
def get_user_list(config, key):
    with open("{}/LEGEND/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "something://somewhat:user@hosturl:port/databasename"  # needed for any database X
    REDIS_URI = " "
    LOAD = []
